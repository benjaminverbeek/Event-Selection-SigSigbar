...
filename = "inclusiveMC_raw_filtered"   # This is 225 M inclusive MC-events filtered for Sigma-masses

# make your best guess:
initialGuess = [600, 1.19, 0.001, 100, 1.19, 0.005]
nBins = 80
...
plt.ylabel('counts')
plt.title('Double Gaussian fit to m(mSigma0) Inclusive MC data')
#plt.show()
plt.savefig('C:/Users/benja/OneDrive/Documents/15c project/USTC/plot-code/imgs/double-gaussian-inclusiveMC-sigma.png')
print(f"Saved plot to C:/Users/benja/OneDrive/Documents/15c project/USTC/plot-code/imgs/double-gaussian-inclusiveMC-sigma.png")
