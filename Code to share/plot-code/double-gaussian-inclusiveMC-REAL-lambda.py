...
initialGuess = [1000, 1.115, 0.0007, 300, 1.115, 0.002]
nBins = 80
...
plt.ylabel('counts')
plt.title('Double Gaussian fit to m(mLambda) real data')
#plt.show()
plt.savefig('C:/Users/benja/OneDrive/Documents/15c project/USTC/plot-code/imgs/double-gaussian-inclusiveMC_lambda-REAL.png')
